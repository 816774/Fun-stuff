package com.sophia.funstuff.item.custom;
...
public class ChiselItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.funstuff.chisel.tooltip"));
        }else {
            tooltip.add(Text.translatable("tooltip.funstuff.chisel.shift_tooltip"));
        }
